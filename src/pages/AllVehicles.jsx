      ...
      <div className=" max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-3 md:gap-0 justify-between items-center ">
          <form onSubmit={handleSearch} className="justify-center flex ">
            ...
            <button
              type="submit"
              className="btn px-4 py-2 w-1/2 font-bold text-white bg-linear-to-r from-cyan-900 via-cyan-700 to-cyan-600  hover:from-cyan-800 hover:via-cyan-700 hover:to-cyan-500 transition-transform"
            >
