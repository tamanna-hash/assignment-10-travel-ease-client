...
const Footer = () => {
  return (
    <div>
      <footer className=" bg-cyan-900 py-3 mt-2">
        <div className="flex flex-col md:flex-row gap-2 justify-between  px-7">
          ...
          <div className="text-white flex gap-2">
            <div className="flex footer flex-col lg:flex-row items-center gap-2 text-xs md:text-sm ">
              ...
              <Link to={"/traveleasePolicy"} className="link link-hover">
                Privacy policy
              </Link>
        ...
        <p className="text-slate-300 text-center text-xs md:text-sm pl-6 pt-3 pb-1">
