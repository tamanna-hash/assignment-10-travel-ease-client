            ...
            <div className="hero bg-base-200 min-h-screen">
                <div className="hero-content flex-col lg:flex-row">
                    ...
                    <div className='items-start'>
                        ...
                        <p className="py-6 text-slate-600 roboto flex items-center gap-2 md:gap-4">
                            <IoMdCheckmarkCircle className='text-sky-400 text-2xl' />
                            <div>
                                <h1 className='text-xl font-bold'>Expert Guidance</h1>
                                <p className=''>Local guides share culture, history, and hidden attractions often missed.</p>
                            </div>
                        </p>
                        <p className="py-6 text-slate-600 roboto flex items-center gap-2 md:gap-4">
                            <IoMdCheckmarkCircle className='text-sky-400 text-2xl' />
                            <div>
                                ...
                                <p className=''>Group tours get better deals, saving money on travel essentials.</p>
                            </div>
                        </p>
                        <p className="py-6 text-slate-600 roboto flex items-center gap-2 md:gap-4">
                            <IoMdCheckmarkCircle className='text-sky-400 text-2xl' />
                            <div>
                                ...
                                <p className=''>Group travel lowers risks in unfamiliar or remote, unsafe destinations.</p>
                            </div>
                        </p>
                        <button className="btn bg-cyan-900 hover:bg-cyan-800 text-white border-white">Get Started</button>
                    </div>
                </div>
            </div>
        </div>
