...
import heroImg from '../assets/travel2.jpg'
const State = () => {
    return (
        <div className='mt-8'>
            <div className='text-center md:py-18 text-white bg-linear-to-r from-cyan-800 via-cyan-700 to-cyan-600'>
                ...
                <div className='flex justify-around md:px-42' >
                    <div className='space-y-3.5 p-3 shadow-2xl rounded-lg bg-linear-to-r from-[#461ea3] to-[#ae83ea]'>
                    ...
                    <div className='space-y-3.5 p-3 shadow-2xl rounded-lg bg-linear-to-r from-[#178a92]  to-[#6bd0d4]'>
                    ...
                    <div className='space-y-3.5 p-3 shadow-2xl rounded-lg bg-linear-to-r  from-[#781c93] to-[#d18dd8] '>
