        ...
        <div className="navbar-start">
          <div className="dropdown">
            <div
              tabIndex={0}
              role="button"
              className="btn btn-ghost hover:bg-transparent text-white lg:hidden"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="navbar-end">
          {loading ? (
            ...
            <div className="flex gap-2">
              <Link
                className="btn btn-sm btn-outline text-amber-300  hover:bg-amber-400 hover:text-white"
                to="/auth/login"
              >
                Login
              </Link>
              <Link
                className="btn btn-sm bg-amber-400 border-amber-400 text-white hover:bg-amber-500"
                to="/auth/register"
              >
                Register
              </Link>
